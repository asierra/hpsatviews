...
/**
 * Applies gamma correction to float radiance data.
 ...
 * @param min_val Radiance range minimum for linear stretch.
 * @param max_val Radiance range maximum for linear stretch.
 */
void dataf_apply_gamma(DataF *data, float gamma, float min_val, float max_val);

/// Applies a 2×2 block-average filter.
