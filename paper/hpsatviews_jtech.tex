%% hpsatviews - Journal of Atmospheric and Oceanic Technology (AMS)
%% Compilar: pdflatex -> bibtex -> pdflatex x2
%%
%% REQUIERE ametsocV6.1.cls y ametsocV6.bst, que NO están versionados: son de
%% AMS y no se redistribuyen desde este repo. Se bajan del "AMS LaTeX Package
%% V6.1" en el sitio de autores de AMS y se dejan en este directorio. El .zip
%% trae además amsdocsV6.1.pdf, el instructivo, y templateV6.1.tex, la plantilla
%% de ejemplo de la que salió este archivo.
%%
%% ESTE NO ES EL MANUSCRITO DE SoftwareX REFORMATEADO.
%% El encuadre cambia: SoftwareX pregunta "¿qué es este software?"; JTECH
%% pregunta "¿qué aprendimos que le sirva a otro grupo?". El artículo es la
%% caracterización de dónde se va el tiempo al generar productos GOES-R, y
%% hpsatviews es el instrumento con el que se midió. Prueba para cada párrafo:
%% ¿esto le sirve a alguien que NO vaya a usar hpsv? Si no, sobra.
%%
%% Plan completo y pendientes: lanot/tmp/plan_jtech.md

\documentclass{ametsocV6.1}

%% Para revisar cómo queda en dos columnas (SOLO uso del autor, no para enviar):
...
%% TODO decidir coautores. La memoria registra que quedó pendiente para el
%% resumen de la RAUGM y nunca se resolvió.
\authors{Alejandro Aguilar Sierra\aff{a}\correspondingauthor{Alejandro Aguilar
Sierra, asierra@unam.mx}}

\affiliation{\aff{a}{Laboratorio Nacional de Observaci\'on de la Tierra (LANOT),
Universidad Nacional Aut\'onoma de M\'exico, Mexico City, Mexico}}

%% Máximo 250 palabras. Redactar AL FINAL, cuando los números estén cerrados.
\abstract{Operational monitoring with geostationary imagery is bounded by a
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Products and reference algorithms}
\label{sec:algorithms}

%% TODO. Breve y con propósito: fijar la línea base de equivalencia, para que
%% la sección 5 pueda afirmar que se compara el MISMO producto.
...
\subsection{Parallel decoding of the input}
\label{sec:decoding}
...
\subsection{Device-resident processing}
\label{sec:device}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\acknowledgments
Developed at the Laboratorio Nacional de Observaci\'on de la Tierra (LANOT),
Universidad Nacional Aut\'onoma de M\'exico, with support from Laboratorio
Nacional SECIHTI 2025--2027, grant LN-2025-C-102.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\datastatement
%% Obligatorio en AMS. Aquí el proyecto está en muy buena posición: los datos
%% de entrada son públicos y los scripts de medición se distribuyen con el
%% código. TODO redactar nombrando:
%%  - GOES-R ABI L1b del bucket público de NOAA en S3, sin credenciales.
%%  - hpsatviews v1.1.0 archivado, DOI 10.5281/zenodo.21893553 (DOI de
%%    concepto 10.5281/zenodo.20817973).
%%  - reproduction/bench_geo2grid.sh y reproduction/compare_g2g_product.sh
%%    reproducen las tablas de la seccion 5.
